...
const caseSchema = new mongoose.Schema({
    ...
    nextHearing: { type: Date }, // Next hearing/court date
    hearingLocation: { type: String }, // Location of the hearing
    priority: { type: String, enum: ["low", "medium", "high"], default: "medium" }, // Case priority
